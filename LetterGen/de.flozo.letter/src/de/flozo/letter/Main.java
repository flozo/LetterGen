...
public class Main {
    ...
    public static final String VERSION_DATE = "2022-07-03";
...
//        masterConfigFile.writeProperties();
        ...
        OutputFile outputFile = new OutputFile(directory, fileName, VERSION_INFO_LATEX_HEADER, finalCode);
