...
public class BackaddressField {
    ...
    public BackaddressField(LetterGeneral general, LetterGeometry geometry, LetterColor color, LetterFont font, Address address) {
        ...
        this.fontSize = font.getBackaddressFontSize();
    }
