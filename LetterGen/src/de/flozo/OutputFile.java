...
public class OutputFile {
    ...
    public static final String VERSION_INFO = "% =====  LaTeX code generated by LetterGen v0.1 (2022-05-17)\n% =====  LetterGen by flozo (https://github.com/flozo/LetterGen)";
    ...
    public boolean writeToFile(List<String> codeLines, String outputFile) {
        ...
        try (PrintWriter printWriter = new PrintWriter(outputFile)) {
            printWriter.println(VERSION_INFO);
